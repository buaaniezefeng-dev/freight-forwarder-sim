        ...
        <div className="px-8 py-6 border-b border-slate-100 bg-slate-50">
           <div className="flex justify-between items-center">
              ...
              <div className="text-center px-8 border-x border-slate-200">
                 <div className="text-sm text-slate-500 font-medium mb-1">评级</div>
                 <div className={`text-5xl font-black ${isPassing ? 'text-brand-600' : 'text-red-500'}`}>{grade}</div>
              </div>
              <div className="text-center">
                 <div className="text-sm text-slate-500 font-medium mb-1">结果</div>
                 <div className="text-lg font-bold text-slate-700">{isPassing ? "优秀" : "未达标"}</div>
              </div>
           </div>
        </div>
